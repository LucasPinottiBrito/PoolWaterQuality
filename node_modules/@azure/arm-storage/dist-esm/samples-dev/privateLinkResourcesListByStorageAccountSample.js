...
function storageAccountListPrivateLinkResources() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.privateLinkResources.listByStorageAccount(resourceGroupName, accountName);
        console.log(result);
    });
}
storageAccountListPrivateLinkResources().catch(console.error);
//# sourceMappingURL=privateLinkResourcesListByStorageAccountSample.js.map