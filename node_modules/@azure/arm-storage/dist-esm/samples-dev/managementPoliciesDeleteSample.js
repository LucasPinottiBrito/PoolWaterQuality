...
function storageAccountDeleteManagementPolicies() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.managementPolicies.delete(resourceGroupName, accountName, managementPolicyName);
        console.log(result);
    });
}
storageAccountDeleteManagementPolicies().catch(console.error);
//# sourceMappingURL=managementPoliciesDeleteSample.js.map