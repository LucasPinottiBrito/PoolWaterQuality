 ...
 * x-ms-original-file: specification/storage/resource-manager/Microsoft.Storage/stable/2022-05-01/examples/FileSharesDelete.json
 */
function deleteShares() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.fileShares.delete(resourceGroupName, accountName, shareName);
        console.log(result);
    });
}
