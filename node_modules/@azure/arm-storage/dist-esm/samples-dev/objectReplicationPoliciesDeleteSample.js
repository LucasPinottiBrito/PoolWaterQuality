...
function storageAccountDeleteObjectReplicationPolicies() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.objectReplicationPoliciesOperations.delete(resourceGroupName, accountName, objectReplicationPolicyId);
        console.log(result);
    });
}
storageAccountDeleteObjectReplicationPolicies().catch(console.error);
//# sourceMappingURL=objectReplicationPoliciesDeleteSample.js.map