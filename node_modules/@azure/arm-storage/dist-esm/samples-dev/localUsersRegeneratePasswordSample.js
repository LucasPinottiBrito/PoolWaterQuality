...
function regenerateLocalUserPassword() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.localUsersOperations.regeneratePassword(resourceGroupName, accountName, username);
        console.log(result);
    });
}
regenerateLocalUserPassword().catch(console.error);
//# sourceMappingURL=localUsersRegeneratePasswordSample.js.map