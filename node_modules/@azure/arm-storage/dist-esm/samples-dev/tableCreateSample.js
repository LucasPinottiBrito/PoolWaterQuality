...
function tableOperationPut() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.tableOperations.create(resourceGroupName, accountName, tableName);
        console.log(result);
    });
}
...
function tableOperationPutOrPatchAcls() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const credential = new DefaultAzureCredential();
        const client = new StorageManagementClient(credential, subscriptionId);
        const result = yield client.tableOperations.create(resourceGroupName, accountName, tableName, options);
        console.log(result);
    });
}
