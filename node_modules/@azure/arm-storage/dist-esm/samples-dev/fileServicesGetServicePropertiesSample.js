 ...
 * x-ms-original-file: specification/storage/resource-manager/Microsoft.Storage/stable/2022-05-01/examples/FileServicesGet.json
 */
function getFileServices() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.fileServices.getServiceProperties(resourceGroupName, accountName);
        console.log(result);
    });
}
