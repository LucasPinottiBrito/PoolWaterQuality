...
function storageAccountGetManagementPolicies() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.managementPolicies.get(resourceGroupName, accountName, managementPolicyName);
        console.log(result);
    });
}
storageAccountGetManagementPolicies().catch(console.error);
//# sourceMappingURL=managementPoliciesGetSample.js.map