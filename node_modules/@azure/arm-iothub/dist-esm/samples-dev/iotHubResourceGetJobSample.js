...
function iotHubResourceGetJob() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.iotHubResource.getJob(resourceGroupName, resourceName, jobId);
        console.log(result);
    });
}
iotHubResourceGetJob().catch(console.error);
//# sourceMappingURL=iotHubResourceGetJobSample.js.map