...
function iotHubManualFailover() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.iotHub.beginManualFailoverAndWait(iotHubName, resourceGroupName, failoverInput);
        console.log(result);
    });
}
iotHubManualFailover().catch(console.error);
//# sourceMappingURL=iotHubManualFailoverSample.js.map