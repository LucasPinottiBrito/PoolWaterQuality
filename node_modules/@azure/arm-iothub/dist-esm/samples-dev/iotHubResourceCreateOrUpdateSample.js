 ...
 */
function iotHubResourceCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.iotHubResource.beginCreateOrUpdateAndWait(resourceGroupName, resourceName, iotHubDescription);
        console.log(result);
    });
}
iotHubResourceCreateOrUpdate().catch(console.error);
//# sourceMappingURL=iotHubResourceCreateOrUpdateSample.js.map