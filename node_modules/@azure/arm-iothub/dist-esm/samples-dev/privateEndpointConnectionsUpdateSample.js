...
function privateEndpointConnectionUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.privateEndpointConnections.beginUpdateAndWait(resourceGroupName, resourceName, privateEndpointConnectionName, privateEndpointConnection);
        console.log(result);
    });
}
privateEndpointConnectionUpdate().catch(console.error);
//# sourceMappingURL=privateEndpointConnectionsUpdateSample.js.map