 ...
 */
function iotHubResourceTestAllRoutes() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.iotHubResource.testAllRoutes(iotHubName, resourceGroupName, input);
        console.log(result);
    });
}
iotHubResourceTestAllRoutes().catch(console.error);
//# sourceMappingURL=iotHubResourceTestAllRoutesSample.js.map