 ...
 */
function resourceProviderCommonGetSubscriptionQuota() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "91d12660-3dec-467a-be2a-213b5544ddc0";
        const credential = new DefaultAzureCredential();
        const client = new IotHubClient(credential, subscriptionId);
        const result = yield client.resourceProviderCommon.getSubscriptionQuota();
        console.log(result);
    });
}
resourceProviderCommonGetSubscriptionQuota().catch(console.error);
//# sourceMappingURL=resourceProviderCommonGetSubscriptionQuotaSample.js.map