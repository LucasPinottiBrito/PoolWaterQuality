...
function certificatesVerify() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.certificates.verify(resourceGroupName, resourceName, certificateName, ifMatch, certificateVerificationBody);
        console.log(result);
    });
}
certificatesVerify().catch(console.error);
//# sourceMappingURL=certificatesVerifySample.js.map