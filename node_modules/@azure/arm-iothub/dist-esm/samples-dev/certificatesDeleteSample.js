...
function certificatesDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.certificates.delete(resourceGroupName, resourceName, certificateName, ifMatch);
        console.log(result);
    });
}
certificatesDelete().catch(console.error);
//# sourceMappingURL=certificatesDeleteSample.js.map