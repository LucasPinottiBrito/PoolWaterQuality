 ...
 */
function iotHubResourceListEventHubConsumerGroups() {
    var e_1, _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _b = __asyncValues(client.iotHubResource.listEventHubConsumerGroups(resourceGroupName, resourceName, eventHubEndpointName)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
...
//# sourceMappingURL=iotHubResourceListEventHubConsumerGroupsSample.js.map