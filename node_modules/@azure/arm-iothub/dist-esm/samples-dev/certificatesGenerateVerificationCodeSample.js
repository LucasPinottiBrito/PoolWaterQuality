 ...
 */
function certificatesGenerateVerificationCode() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.certificates.generateVerificationCode(resourceGroupName, resourceName, certificateName, ifMatch);
        console.log(result);
    });
}
certificatesGenerateVerificationCode().catch(console.error);
//# sourceMappingURL=certificatesGenerateVerificationCodeSample.js.map