 ...
 */
function certificatesCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.certificates.createOrUpdate(resourceGroupName, resourceName, certificateName, certificateDescription);
        console.log(result);
    });
}
certificatesCreateOrUpdate().catch(console.error);
//# sourceMappingURL=certificatesCreateOrUpdateSample.js.map