...
function iotHubResourceListEventHubConsumerGroups() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.iotHubResource.getEventHubConsumerGroup(resourceGroupName, resourceName, eventHubEndpointName, name);
        console.log(result);
    });
}
iotHubResourceListEventHubConsumerGroups().catch(console.error);
//# sourceMappingURL=iotHubResourceGetEventHubConsumerGroupSample.js.map