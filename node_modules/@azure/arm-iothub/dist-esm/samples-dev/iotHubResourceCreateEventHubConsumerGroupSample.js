 ...
 */
function iotHubResourceCreateEventHubConsumerGroup() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.iotHubResource.createEventHubConsumerGroup(resourceGroupName, resourceName, eventHubEndpointName, name, consumerGroupBody);
        console.log(result);
    });
}
iotHubResourceCreateEventHubConsumerGroup().catch(console.error);
//# sourceMappingURL=iotHubResourceCreateEventHubConsumerGroupSample.js.map