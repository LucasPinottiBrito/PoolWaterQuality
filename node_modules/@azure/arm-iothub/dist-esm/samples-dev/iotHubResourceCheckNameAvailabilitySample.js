 ...
 */
function iotHubResourceCheckNameAvailability() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "91d12660-3dec-467a-be2a-213b5544ddc0";
        const operationInputs = { name: "test-request" };
        const credential = new DefaultAzureCredential();
        const client = new IotHubClient(credential, subscriptionId);
        const result = yield client.iotHubResource.checkNameAvailability(operationInputs);
        console.log(result);
    });
}
iotHubResourceCheckNameAvailability().catch(console.error);
//# sourceMappingURL=iotHubResourceCheckNameAvailabilitySample.js.map