 ...
 */
function certificatesListByIotHub() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.certificates.listByIotHub(resourceGroupName, resourceName);
        console.log(result);
    });
}
certificatesListByIotHub().catch(console.error);
//# sourceMappingURL=certificatesListByIotHubSample.js.map